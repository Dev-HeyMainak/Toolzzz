    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      ...
      <section className="max-w-2xl mx-auto bg-card p-8 rounded-xl shadow-lg space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            We are passionate about building helpful software. We prioritize user experience, aiming for clean interfaces and straightforward functionality. While we may explore premium features in the future, our core commitment is to maintain a robust set of free tools for our community. Your feedback is invaluable in shaping the future of Toolzzz.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Toolzzz was started by a small team of developers and designers who saw a need for a consolidated, free online utility suite. We&apos;re dedicated to continuous improvement and adding more value for our users.
          </p>
        </div>

        <p className="text-muted-foreground pt-4 border-t border-border text-center">
          Thank you for using Toolzzz!
        </p>
      </section>
    </div>
  );
